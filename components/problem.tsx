      ...
      <div className="mx-auto max-w-4xl px-5 md:px-8">
        ...
        <Reveal delay={100}>
          <div className="mt-10 space-y-4 text-center text-pretty leading-relaxed text-muted-foreground sm:text-lg">
            <p>היזם משקיע שנים בתכנון. בוחר אדריכלים, עובד עם יועצים, מנהל תקציבים ומקדם הליכי רישוי.</p>
            <p className="text-foreground/90 font-medium">אולם, במקרים רבים החשיבה השיווקית מתחילה רק כאשר הפרויקט כבר מוכן לשיווק.</p>
            <p>בשלב זה, חלק מן ההחלטות המשמעותיות ביותר כבר התקבלו:</p>
          </div>
        </Reveal>
