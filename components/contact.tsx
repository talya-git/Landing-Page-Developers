    ...
    <section id="contact" className="relative py-14 md:py-20">
      <div className="mx-auto max-w-4xl px-5 md:px-8">
        <Reveal className="text-center">
          <img src="/media/a-z.png" alt="Oren Cohen Group" className="mx-auto h-20 w-auto" />
          <h2 className="mt-7 font-heading text-3xl font-medium leading-tight tracking-tight text-balance text-gold-gradient sm:text-4xl md:text-5xl">
            בואו נמתג את הפרויקט הבא שלכם
          </h2>
          <p className="mt-5 text-pretty leading-relaxed text-muted-foreground">
            מוכנים להעלות את השיווק של הפרויקט שלכם לרמה הבאה? צרו קשר ונדבר על איך נוכל לעזור לכם למכור מהר יותר.
          </p>
        </Reveal>
