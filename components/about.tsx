      ...
      <div className="mx-auto grid max-w-6xl items-center gap-12 px-5 md:grid-cols-2 md:gap-20 md:px-8">
        ...
        <Reveal delay={120}>
          ...
          <p className="mt-6 text-pretty leading-relaxed text-muted-foreground">
            אורן כהן גרופ פועלת למעלה משלושה עשורים בעולם הנדל"ן.
          </p>
          <p className="mt-4 text-pretty leading-relaxed text-muted-foreground">
            לאורך השנים ליווינו, מיתגנו ושיווקנו למעלה מ־70 פרויקטים למגורים, פגשנו אלפי רוכשים וליווינו יזמים בכל שלבי הדרך.
          </p>
          <p className="mt-4 text-pretty leading-relaxed text-muted-foreground">
            במהלך השנים צברנו הבנה עמוקה של הגורמים שהופכים פרויקט למבוקש — כזה שמייצר ביקוש, בולט בשוק ומגיע לתוצאות.
          </p>
          <p className="mt-4 text-pretty leading-relaxed text-muted-foreground">
            הניסיון הזה הוא הבסיס לכל החלטה שאנו מקבלים עבור לקוחותינו.
          </p>
