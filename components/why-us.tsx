...
const reasons = [
  {
    ...
    text: "אנחנו יודעים כמה החלטות, משאבים וסיכונים מושקעים בכל פרויקט, ולכן אנו חושבים ופועלים מתוך נקודת המבט של היזם.",
  },
  {
    num: "02",
    title: "אנחנו מחוברים לשטח",
    text: "אנו פוגשים מדי יום רוכשים אמיתיים, מקשיבים להם, מבינים את הצרכים שלהם ומה מניע את תהליך קבלת ההחלטות שלהם.",
  },
  {
    num: "03",
    title: "אנחנו מחברים בין כל העולמות",
    text: "אסטרטגיה, מיתוג, קריאייטיב, דיגיטל ומכירות — כולם עובדים יחד, כחלק מתהליך אחד.",
  },
  {
    num: "04",
    title: "אנחנו חושבים לטווח ארוך",
    text: "המטרה שלנו אינה רק להשיק את הפרויקט בהצלחה, אלא לבנות עבורו הצלחה מתמשכת לאורך שנים.",
  },
]
